class Key {
  ...
  Key(this.key);
  static Key fromUtf8(String key) {
    return Key(key.codeUnits);
  }
}
...
class IV {
  ...
  static IV fromUtf8(String iv) {
    return IV(iv.codeUnits);
  }
}
...
class AES {
  ...
  static List<int> invCfb(
      List<int> pwdArray, List<int> ivArray, List<int> ptByteArray) {
  ...
  static List<int> keyExpansion(List<int> key) {
  ...
  static List<int> i8ListToI32List(List<int> i8List) {
  ...
  AES(this.key, {this.mode = AESMode.cfb, this.padding});
  ...
  static List<int> cipher(List<int> input, List<int> w) {
